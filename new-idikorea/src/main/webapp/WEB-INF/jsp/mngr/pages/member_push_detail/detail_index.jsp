...
<div class="middleArea">
	...
	<jsp:include page="../../include/sidemenu.jsp" flush="false">
		...
		<jsp:param name="depth_01" value="sideMenu_05_04" />
		<jsp:param name="depth_02" value="sideMenu_05_04_02" />
	</jsp:include>
	...
	<div class="pageContent">
		<div class="contentTitle">
			<div class="currentPage">
				...
				<i class="fa fa-angle-right" aria-hidden="true"></i> 푸시알림
				<i class="fa fa-angle-right" aria-hidden="true"></i> 발송내역
			</div>
			<h2>발송내역</h2>
		</div>
