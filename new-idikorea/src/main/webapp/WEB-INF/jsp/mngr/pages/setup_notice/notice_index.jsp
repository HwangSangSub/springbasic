...
<div class="middleArea">
	...
	<jsp:include page="../../include/sidemenu.jsp" flush="false">
		...
		<jsp:param name="depth_01" value="sideMenu_12_07" />
		<jsp:param name="depth_02" value="sideMenu_12_07_01" />
	</jsp:include>
	...
	<div class="pageContent">
		<div class="contentTitle">
			<div class="currentPage">
				...
				<i class="fa fa-angle-right" aria-hidden="true"></i> 알림톡자동발송 &middot; 설정
			</div>
			<h2>알림톡자동발송 &middot; 설정</h2>
		</div>
