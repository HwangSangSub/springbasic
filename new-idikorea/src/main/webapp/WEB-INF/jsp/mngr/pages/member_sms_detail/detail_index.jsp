...
<div class="middleArea">
	...
	<jsp:include page="../../include/sidemenu.jsp" flush="false">
		...
		<jsp:param name="depth_01" value="sideMenu_05_03" />
		<jsp:param name="depth_02" value="sideMenu_05_03_02" />
	</jsp:include>
	...
	<div class="pageContent">
		<div class="contentTitle">
			<div class="currentPage">
				...
				<i class="fa fa-angle-right" aria-hidden="true"></i> SMS
				<i class="fa fa-angle-right" aria-hidden="true"></i> SMS발송내역
			</div>
			<h2>SMS발송내역</h2>
		</div>
