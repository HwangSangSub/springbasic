...
<div class="wrap wrap-<%=pagetype%>">	
                ...
                <ol class="join-step-list">
                    <li class="join-step-li">
                        <div class="join-step-box">
                            <img src="/images/user/join/img_join_01_on.png" alt="">
                            <span class="active">약관동의</span>
                        </div>
                    </li>
                    <li class="join-step-li">
                        <div class="join-step-box">
    ...
    <section class="join-sect sect-terms">
        <div class="layout">
            <div class="join-terms">
                <label class="checkbox round join-check">
                    <input type="checkbox" name="" id="">
                    <div class="icon"></div>
                    <div class="txt">약관 동의</div>
                </label>
                <div class="terms">
                    <ul class="clearfix">
                        <li>
                            ...
                            <ul class="clearfix">
                                <li>
                                    이 약관은 이디코리아 (전자상거래 사업자)가 운영하는 미플(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리 · 의무 및 책임사항을 규정함을 목적으로 합니다. 
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="clearfix">
                                <li>
                                    1. “몰”이란 이디코리아 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
                                </li>
                                <li>
                        ...
                        <li>
                            <h4>제9조(구매신청) "몰"이용자는 "몰"상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, "몰"은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다. 단, 회원인 경우 제2호 내지 제4호의 적용을 제외할 수 있습니다.</h4>
                            <ul class="clearfix">
                        ...
                        <li>
                            <h4>제11조(지급방법) "몰"에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각호의 방법중 가용한 방법으로 할 수 있습니다. 단, "몰"은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도 추가하여 징수할 수 없습니다.</h4>
                            <ul class="clearfix">
                        ...
                        <li>
                            <h4>제20조(이용자의 의무) 이용자는 다음 행위를 하여서는 안됩니다.</h4>
                            <ul class="clearfix">
                        ...
                        <li>
                            <h4>부칙</h4>
                            <ul class="clearfix">
                                <li>1. 이 약관은 2012년 01월 01일부터 적용됩니다.</li>
                            </ul>
                        </li>
                    </ul>
                </div>
