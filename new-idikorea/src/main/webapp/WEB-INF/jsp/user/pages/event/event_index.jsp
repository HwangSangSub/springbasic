...
<%
	...
	class Board {
		...
		public Board() {}
		public Board(String startDate, String endDate, String tit, String writer, String cont, String day, String hits, String progress, String thumbnail) {
			this.tit = tit;
			this.writer = writer;
			this.cont = cont;
			this.day = day;
	...
	boards[0] = new Board("2222", "2222", "제목1", "작성자", "내용1", "날짜", "조회수", "now", "/images/user/sample/event2.png");
	boards[0].attachment = "첨부파일";
	boards[1] = new Board("2222", "2222", "제목2", "작성자", "내용2", "날짜", "조회수", "now", "/images/user/sample/event2.png");
	boards[2] = new Board("2222", "2222", "제목3", "작성자", "내용3", "날짜", "조회수", "unready", "/images/user/sample/event2.png");
	boards[3] = new Board("2222", "2222", "제목4", "작성자", "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam nobis voluptate eveniet officiis porro aperiam illum. Quam illum molestiae, fugiat incidunt nam est, dolorem, iure atque a laudantium eos earum.", "날짜", "조회수", "off", "/images/user/sample/event2.png");
					...
					<div class="modal-wrap modal-sub-menus-wrap">
						<div class="modal modal-sub-menus">
							...
							<div class="modal-main">
								<div class="sub-menus-tit">event</div>
							...
							<div class="sub-view">
								<div class="board">
									...
									<jsp:include page="../board/board_common_form.jsp" flush="false" >	
										<jsp:param name="isEvent" value="true" />	
									</jsp:include>
									<!-- 새글 -->
		
		
									<!-- 게시판목록 -->
									<div class="event_type detail-tabview-bd-wrap bd-wrap">     
										...
										<div class="event_list event-list-wrap">
											<ul class="clearfix">
												<%	for(Board bd : boards ) { %>
												<li class="event-box">
													<div class="left event-plate event-plate-img">
														<a href="javascript:void(0);" class="">
															<div class="event_icon">
																<!-- off, unready, now -->
																<span class="<%=bd.progress%>">
																	<% if(bd.progress == "off") { %> 종료
																	<% } else if(bd.progress == "unready") { %> 예정
																	<% } else if(bd.progress == "now") { %> 진행중 <% } %>
																</span>
															</div>
															<div class="event-thumbnail-img-wrap">
																<img src="<%=bd.thumbnail%>" alt="event-thumbnail-img">
															</div>
														</a>
													</div>
													<div class="right event-plate event-plate-info">
														<div class="">
															<a href="javascript:void(0);" class="btn"><%=bd.tit%></a>
															<p class="textCut lineskip-1"><%=bd.cont%></p>
															<p class="period"><%=bd.startDate%> ~ <%=bd.endDate%></p>
														</div>
													</div>
												</li>
												<% } %>
												<li class="event-box empty">
...
<script src="/js/user/pages/event/event_index.js"></script>
